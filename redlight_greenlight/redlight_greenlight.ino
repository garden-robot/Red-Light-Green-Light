...
if (buttonMultiClicked())
{
  ...
  teamScores[teamIndex] -= clicks; //add multi-clicks to array of scores that align with team colours
}

if(teamScores[teamIndex] < 0){ //if value drops below 0 just round it to 0;
